...
\begin{block}{Example 4.1: Remission data - stratification by Sex}
\begin{itemize}
...
\begin{block}{Problem 4.1: Remission data - stratification by Sex}
\begin{enumerate}
...
\begin{block}{Example 4.2: Remission data - stratification by Sex with interaction}
\begin{itemize}
...
\begin{block}{Example 4.2: Remission data - stratification by Sex with interaction (cont'd)}
\begin{itemize}
