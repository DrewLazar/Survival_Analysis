...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#We use a trick here and recode Mft=0 as Mft2={-}1 and Mft=1 as Mft2=0 and refit the model with Mft2 rather than Mft. }
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Based on the adjusted survival curve we choose t=3.5 as a split (or cut) point. }
\NormalTok{Venreset.cp3}\FloatTok{.5}\OtherTok{=}\FunctionTok{survSplit}\NormalTok{(Ven.reset,}\AttributeTok{cut=}\DecValTok{3}\NormalTok{,}\AttributeTok{end=}\StringTok{"eventtime"}\NormalTok{,}\AttributeTok{event=}\StringTok{"status"}\NormalTok{,}\AttributeTok{start=}\StringTok{"start"}\NormalTok{,}\AttributeTok{id=}\StringTok{"id"}\NormalTok{)}
\NormalTok{Venreset.cp3}\FloatTok{.5}\SpecialCharTok{$}\NormalTok{hv2}\OtherTok{=}\NormalTok{Venreset.cp3}\FloatTok{.5}\SpecialCharTok{$}\NormalTok{Mft}\SpecialCharTok{*}\NormalTok{(Venreset.cp3}\FloatTok{.5}\SpecialCharTok{$}\NormalTok{start}\SpecialCharTok{\textgreater{}=}\DecValTok{3}\NormalTok{)}
