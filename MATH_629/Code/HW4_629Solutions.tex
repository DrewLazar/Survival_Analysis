...
\hypertarget{ii.-testing-mft-with-setting-and-lo2-in-the-model}{%
\subsection{2ii. Testing MFt with Setting and LO2 in the
model}\label{ii.-testing-mft-with-setting-and-lo2-in-the-model}}
...
\FunctionTok{plot}\NormalTok{(}\FunctionTok{survfit}\NormalTok{(Coxph.Ven.m0, }\AttributeTok{newdata =}\NormalTok{ pattern), }\AttributeTok{fun =} \StringTok{"cloglog"}\NormalTok{, }\AttributeTok{conf.int =}\NormalTok{ F, }\AttributeTok{xlim =} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}
...
\FunctionTok{plot}\NormalTok{(}\FunctionTok{survfit}\NormalTok{(coxph.Ven.m1, }\AttributeTok{newdata =}\NormalTok{ pattern1), }\AttributeTok{col =} \FunctionTok{c}\NormalTok{(}\StringTok{"blue"}\NormalTok{, }\StringTok{"red"}\NormalTok{), }\AttributeTok{conf.int =}\NormalTok{ F,}
    \AttributeTok{main =} \StringTok{"Adjusted survival for Setting=0, 1 and 2, mean(LO2) from stratified Cox PH model"}\NormalTok{)}
...
\FunctionTok{par}\NormalTok{(}\AttributeTok{new =} \ConstantTok{TRUE}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(}\FunctionTok{survfit}\NormalTok{(coxph.Ven.m1, }\AttributeTok{newdata =}\NormalTok{ pattern2), }\AttributeTok{col =} \FunctionTok{c}\NormalTok{(}\StringTok{"blue"}\NormalTok{, }\StringTok{"red"}\NormalTok{), }\AttributeTok{lty =} \FunctionTok{c}\NormalTok{(}\StringTok{"dashed"}\NormalTok{),}
...
\FunctionTok{par}\NormalTok{(}\AttributeTok{new =} \ConstantTok{TRUE}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(}\FunctionTok{survfit}\NormalTok{(coxph.Ven.m1, }\AttributeTok{newdata =}\NormalTok{ pattern3), }\AttributeTok{col =} \FunctionTok{c}\NormalTok{(}\StringTok{"blue"}\NormalTok{, }\StringTok{"red"}\NormalTok{), }\AttributeTok{lty =} \FunctionTok{c}\NormalTok{(}\StringTok{"dotted"}\NormalTok{),}
    \AttributeTok{conf.int =}\NormalTok{ F)}
\FunctionTok{legend}\NormalTok{(}\StringTok{"topright"}\NormalTok{, }\AttributeTok{cex =} \FloatTok{0.75}\NormalTok{, }\FunctionTok{c}\NormalTok{(}\StringTok{"Setting=0, Mft=0"}\NormalTok{, }\StringTok{"Setting=0, Mft=1"}\NormalTok{, }\StringTok{"Setting=1, Mft=0"}\NormalTok{,}
    \StringTok{"Setting=1,Mft=1"}\NormalTok{, }\StringTok{"Setting=2, Mft=0"}\NormalTok{, }\StringTok{"Setting=2, Mft=1"}\NormalTok{), }\AttributeTok{lty =} \FunctionTok{c}\NormalTok{(}\StringTok{"solid"}\NormalTok{,}
    \StringTok{"solid"}\NormalTok{, }\StringTok{"dashed"}\NormalTok{, }\StringTok{"dashed"}\NormalTok{, }\StringTok{"dotted"}\NormalTok{, }\StringTok{"dotted"}\NormalTok{), }\AttributeTok{col =} \FunctionTok{c}\NormalTok{(}\StringTok{"blue"}\NormalTok{, }\StringTok{"red"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# We use a trick here and recode Mft=0 as Mft2={-}1 and Mft=1 as Mft2=0 and refit}
\CommentTok{\# the model with Mft2 rather than Mft.}
\NormalTok{Ven.reset}\SpecialCharTok{$}\NormalTok{Mft2 }\OtherTok{=}\NormalTok{ Ven.reset}\SpecialCharTok{$}\NormalTok{Mft }\SpecialCharTok{{-}} \DecValTok{1}
\NormalTok{coxph.Ven.int.m2 }\OtherTok{\textless{}{-}} \FunctionTok{coxph}\NormalTok{(Y }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Setting }\SpecialCharTok{+}\NormalTok{ LO2 }\SpecialCharTok{+}\NormalTok{ Mft2}\SpecialCharTok{:}\NormalTok{LO2 }\SpecialCharTok{+}\NormalTok{ Mft2}\SpecialCharTok{:}\NormalTok{Setting }\SpecialCharTok{+} \FunctionTok{strata}\NormalTok{(Mft2),}
    \AttributeTok{data =}\NormalTok{ Ven.reset)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{time }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{6}\NormalTok{, }\DecValTok{6}\NormalTok{, }\DecValTok{7}\NormalTok{, }\DecValTok{8}\NormalTok{)}
\NormalTok{status }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{)}
\NormalTok{Dose }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{, }\FloatTok{1.5}\NormalTok{, }\DecValTok{2}\NormalTok{, }\FloatTok{1.5}\NormalTok{)}
...
\hypertarget{i.-1}{%
\subsection{7 i.}\label{i.-1}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Our adjusted survival Curves.}
...
\NormalTok{settingmean }\OtherTok{=} \FunctionTok{mean}\NormalTok{(Ven.reset}\SpecialCharTok{$}\NormalTok{Setting)}
...
\FunctionTok{plot}\NormalTok{(}\FunctionTok{survfit}\NormalTok{(Coxph.ven3, }\AttributeTok{newdata =}\NormalTok{ pattern1), }\AttributeTok{conf.int =}\NormalTok{ F, }\AttributeTok{main =} \StringTok{"Adjusted survival for Mft=0 vs Mft=1, mean(Setting), mean(LO2)"}\NormalTok{,}
...
\FunctionTok{legend}\NormalTok{(}\StringTok{"topright"}\NormalTok{, }\FunctionTok{c}\NormalTok{(}\StringTok{"Mft=0"}\NormalTok{, }\StringTok{"Mft=1"}\NormalTok{), }\AttributeTok{lty =} \FunctionTok{c}\NormalTok{(}\StringTok{"solid"}\NormalTok{), }\AttributeTok{col =} \FunctionTok{c}\NormalTok{(}\StringTok{"blue"}\NormalTok{, }\StringTok{"red"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{HW4_629Solutions_files/figure-latex/unnamed-chunk-16-1.pdf}

\#\#7 ii.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Based on the adjusted survival curve we choose t=3.5 as a split (or cut)}
\CommentTok{\# point.}
\NormalTok{Venreset.cp3}\FloatTok{.5} \OtherTok{=} \FunctionTok{survSplit}\NormalTok{(Ven.reset, }\AttributeTok{cut =} \FloatTok{3.5}\NormalTok{, }\AttributeTok{end =} \StringTok{"eventtime"}\NormalTok{, }\AttributeTok{event =} \StringTok{"status"}\NormalTok{,}
    \AttributeTok{start =} \StringTok{"start"}\NormalTok{, }\AttributeTok{id =} \StringTok{"id"}\NormalTok{)}
\NormalTok{Venreset.cp3}\FloatTok{.5}\SpecialCharTok{$}\NormalTok{hv2 }\OtherTok{=}\NormalTok{ Venreset.cp3}\FloatTok{.5}\SpecialCharTok{$}\NormalTok{Mft }\SpecialCharTok{*}\NormalTok{ (Venreset.cp3}\FloatTok{.5}\SpecialCharTok{$}\NormalTok{start }\SpecialCharTok{\textgreater{}=} \FloatTok{3.5}\NormalTok{)}
\NormalTok{Y4 }\OtherTok{=} \FunctionTok{Surv}\NormalTok{(Venreset.cp3}\FloatTok{.5}\SpecialCharTok{$}\NormalTok{start, Venreset.cp3}\FloatTok{.5}\SpecialCharTok{$}\NormalTok{eventtime, Venreset.cp3}\FloatTok{.5}\SpecialCharTok{$}\NormalTok{status)}
\NormalTok{coxph.Venreset.hs2 }\OtherTok{\textless{}{-}} \FunctionTok{coxph}\NormalTok{(Y4 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Setting }\SpecialCharTok{+}\NormalTok{ LO2 }\SpecialCharTok{+}\NormalTok{ Mft }\SpecialCharTok{+}\NormalTok{ hv2 }\SpecialCharTok{+} \FunctionTok{cluster}\NormalTok{(id), }\AttributeTok{data =}\NormalTok{ Venreset.cp3}\FloatTok{.5}\NormalTok{)}
...
h(t) = \begin{cases} 1 \text{ if } t \ge 0 \\
                     0 \text{ if } t < 0.
        \end{cases}
\] As \(\delta\) has p-value of \(0.0160\) the interaction term is
...
\hypertarget{iii.-1}{%
\subsection{7iii.}\label{iii.-1}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# We fit an extended model with h(t)=ln(t)}
